...
public class World {
	...
	public static void createWorld() {
		System.out.println("    #### Chargement des Donn�es Dynamiques ####");
		...
		System.out.println("        > R�cup�ration des BANS IP ....");
		SQLManager.load_IP_Bans();
		System.out.println("        > R�cup�ration des BANS IP : OK. (" + World.IP_Bans.size() + ")\n");
	}
	
	public static void addAccount(Account ac) {
		Accounts.put(ac.get_GUID(), ac);
	}
	
	public static void deleteAccount(Account ac) {
		Accounts.remove(ac.get_GUID());
	}
